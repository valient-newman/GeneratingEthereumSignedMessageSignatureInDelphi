...
program GeneratingEthereumSignedMessageSignatureInDelphi;

uses
  Vcl.Forms,
  GeneratingEthereumSignedMessageSignatureInDelphiUnit in 'GeneratingEthereumSignedMessageSignatureInDelphiUnit.pas' {Form1};
